...
package org.cytoscape.automorphismInspector.internal.results;
...
public class ResultsGUI extends javax.swing.JPanel implements CytoPanelComponent{
     ...
     */
    public ResultsGUI(CyServiceRegistrar cyRegistrar) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Node mapping"));
        ...
        jLabel1.setText("Automorphic group");

        jLabel2.setText("Computing number of Automorphic mappings...");
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    private void selectNodesInNetworks(cellData[] data){
        ...
        //update views
        Collection<CyNetworkView> c1 = cyRegistrar.getService(CyNetworkViewManager.class).getNetworkViews(net1);
        Iterator<CyNetworkView> it1 = c1.iterator();
        while(it1.hasNext())
            it1.next().updateView();
        Collection<CyNetworkView> c2 = cyRegistrar.getService(CyNetworkViewManager.class).getNetworkViews(net2);
